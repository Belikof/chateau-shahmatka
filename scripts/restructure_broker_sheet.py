...
INSTRUCTION = (
    "КАК ПОСТАВИТЬ БРОНЬ\n\n"
    "1. Найдите участок в списке ниже (фильтр в шапке таблицы)\n"
    "2. В столбце «Статус» выберите «Бронь»\n"
    "3. Примечание к номеру: дата, брокер, срок брони\n"
    "4. Цвет на «Квартал 1» обновится сам\n\n"
    "Свободно — в продаже  |  Бронь — забронирован  |  "
    "Резерв — на согласовании  |  Продано — закрыто"
)
...
def restructure(ss) -> None:
    ...
    hdr = INSTR_LINES + 1  # строка заголовка таблицы (1-based)
